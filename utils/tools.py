...
class Tools ():
    ...
    def createReadMe( self, numChannels, data ):
        ...
        file.write('''\n''')
        file.write('''Este projeto tem visa montar um banco de dados com os canais disponíveis no Brasil de forma gratuita, via FTA (free-to-air), que se encontram na internet, com o objetivo de dinfundir o conhecimento sobre IPTV e o acesso a informação.\n''')
        file.write('''\n''')
        file.write('''Além disso possui um sistema de verificação da validade do link cadastrado, que pode ser visto em `main.py`,que gera a lista `playlist.m3u8`, contendo apenas canais em funcionamento.\n''')
        file.write('''\n''')
        file.write('''```sh\n''')
